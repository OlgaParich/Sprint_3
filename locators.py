...
class TestLocators:
    ...
    BUTTON_LOG_IN_ON_LOGIN_FORM = By.XPATH, './/button[text()="Войти"]'  # "Войти" на форме входа
    ...
    INPUT_NAME_ON_REGISTRATION_FORM = \
        By.XPATH, './/fieldset[@class = "Auth_fieldset__1QzWN mb-6"][1]//input'  # "Имя" на форме регистрации
    ...
    BUTTON_REGISTER_ON_REGISTRATION_FORM = \
        By.XPATH, './/button[text()="Зарегистрироваться"]'  # "Зарегистрироваться" на форме регистрации
    ERROR_INCORRECT_PASSWORD = \
        By.XPATH, './/fieldset//p[@class = "input__error text_type_main-default"]'  # Ошибка "Некорректный пароль"
