...
from generator_email_and_pass import generator_email
from generator_email_and_pass import generator_pass
...
def test_registrations(work_browser):
    ...
    work_browser.find_element(*TestLocators.INPUT_EMAIL_ON_REGISTRATION_FORM).send_keys(generator_email())
    work_browser.find_element(*TestLocators.INPUT_PASSWORD_ON_REGISTRATION_FORM).send_keys(generator_pass())
